    ...
    const load = async () => {
      try {
        ...
        setInitialData({
          ...
          stockCount: String(car.stock_count ?? 1),
          fuel: car.fuel ?? "",
          transmission: car.transmission ?? "",
          driveType: car.drive_type ?? "",
          horsepower: String(car.horsepower ?? ""),
          range: String(car.range ?? ""), // ✅ FIXED
          ...
          fullOption: Boolean(car.fullOption ?? car.full_option),
      ...
      const nextCars = parsed.data.map((car) =>
        Number(car.id) === id
          ? {
              ...
              fullOption: payload.fullOption,
              full_option: payload.fullOption,
